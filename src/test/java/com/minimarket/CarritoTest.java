...
public class CarritoTest {
    ...
    // Concepto 3: @Test - Declaración de la prueba unitaria
    // Resumen: Le indica a Maven Surefire que este método es evaluable.
    @Test
    void testAsignacionUsuarioYProductoAlCarrito() {
        // Continuación del Concepto 2: Arrange (Preparar)
        Integer cantidadComprada = 3;

        // Concepto 3: Act (Actuar)
        // Resumen: Ejecutamos el comportamiento de la entidad. Asignamos los objetos y la cantidad.
        carrito.setUsuario(usuario);
        carrito.setProducto(producto);
        carrito.setCantidad(cantidadComprada);

        // Concepto 4: Assert (Afirmar)
        // Resumen: Comprobamos rigurosamente que los datos guardados en el Carrito 
        // correspondan exactamente a lo que ingresamos.
        
        // 4.1: Validamos que los objetos no sean nulos
        ...
        // 4.2: Validamos la integridad de los datos relacionados
        ...
        // 4.3: Validamos la asignación de valores primitivos/envoltorios
